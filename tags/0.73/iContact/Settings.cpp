...
Settings::Settings(void) {
    ...
    this->email_account = ini.GetValue(
        MAIN_SECTION, TEXT("EmailAccount"), TEXT("default"));
    ...
    this->doFastGraphics = 0 == wmemcmp(ini.GetValue(
        MAIN_SECTION, TEXT("FastGraphics"), TEXT("1")), TEXT("1"), 1);
	...
	this->add_new_contact_string = ini.GetValue(
		LANGUAGE_SECTION, TEXT("addNewContact"), TEXT("Add new contact"));
    ...
    this->company_string = ini.GetValue(
        TEXT("language"), TEXT("company"), TEXT("Company"));
    ...
    this->rgbListItemHoverBackground1 = this->initColor(
		THEME_SECTION, TEXT("ListItemHoverBackground1"), TEXT("000000"));
    
    this->rgbListItemHoverBackground2 = this->initColor(
		THEME_SECTION, TEXT("ListItemHoverBackground2"), TEXT("282828"));
	...
	this->rgbListIndicatorText = this->initColor(
		THEME_SECTION, TEXT("ListIndicatorText"), TEXT("ffffff"));
