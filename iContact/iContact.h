...
#define SZ_ABOUT                    TEXT("iContact v0.72 - supware.net")
...
// Transition effects
#define T_SLIDE_LEFT                1000
#define T_SLIDE_RIGHT               1001
#define T_KEYBOARD                  1002
...
void DrawListOn(HDC, HDC, RECT);
void DrawGroupHeaderOn(HDC, int, RECT);
void DrawItemDetailsOn(HDC, Data, RECT);
